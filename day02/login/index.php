...
<body>
    ...
    <nav class="sticky-top navbar navbar-expand-lg navbar-light flex-grow-1">
        ...
        <ul class="navbar-nav ml-auto flex-nowrap">
            <li class="nav-item"><a class="nav-link" href="./day02/index.php">LOGOUT</a></li>
        </ul>
    </nav>
    ...
    <div id="login" class="container-fluid">
        ...
        <div class="col-xl-6 p-0 col-md-6 col-sm-12">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off">
                ...
                <a href="./day02/index.php"><input class="btn" name= "btn-login" value="HOME"></a>
                <a href="./day02/login/register.php">Sign Up Here...</a>
